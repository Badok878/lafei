...
-----END PUBLIC KEY-----';
    ...
    public static function getParams(){
        ...
        $notify_url = self::getRootUrl().'/index.php?s=/home/recharge/zf_server1';
...
/////////////////////////////   获取sign值（RSA-S加密）  /////////////////////////////////
    ...
    public static function doPost($url,$params)
    {
        ...
        curl_setopt ($ch, CURLOPT_REFERER, 'http://tiegenmy.com/index.php?s=/home/recharge/index.html');
...
//        curl_setopt ($ch, CURLOPT_REFERER, 'http://www.asttf.cn/recharge/index.html');
