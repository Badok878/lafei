...
class YiTongPay
{
    ...
    //qq扫码支付
    public  static function quickPay($order,$uid)
    {
        ...
        $quickParams = [
            ...
            'backURL' => 'http://'.$_SERVER['HTTP_HOST']."/home/recharge/payResult",
            'orderInfo' => self::strToHex('商户订单快捷支付'),
            'userId' => '',
            'userPhoneHF' => $order['userPhoneHF'],
            'userAcctNo' => $order['userAcctNo'],
            'userNameHF' => self::strToHex($order['userNameHF']),
