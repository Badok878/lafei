                ...
                <form method="post" id="login" action="<?php echo U('user/logined');?>" enter="true">
                    ...
                    <div class="loginformboxcontent">
                        <p>
                            ...
                            <input style="ime-mode:disabled;" autocomplete="off" placeholder="请输入用户名" maxlength="20" id="username" name="username" type="text">
                        </p>
                        <p>
                            <i class="fa fa-asterisk"></i>
                            <input style="ime-mode:disabled;" maxlength="20" autocomplete="off" placeholder="请输入密码" id="password" name="password" type="password">
                        </p>
                        <p>
                            <i class="fa fa-asterisk"></i>
                            <input style="ime-mode:disabled;" maxlength="4" autocomplete="off" placeholder="请输入验证码" id="verify" name="verify" type="text">
                            <img id="ReCaptcha_CodeImage" class="verifyimg reloadverify" style="cursor: pointer;height:43px; width:90px;" src="<?php echo U('verify');?>" alt="点击切换" onclick="this.src=this.src+'&'+Math.random()">
                        </p>
                        <div>
