...
<body class="nifty-ready" style="background-color: #f8f3f0; overflow:hidden;">
    <div id="container" class="effect mainnav-lg mainnav-fixed navbar-fixed footer-fixed">
        <!--通知轮播-->
        <style type="text/css">
            #gongao{width:100%;height:30px;overflow:hidden;line-height:30px;font-size:13px;font-family:'宋体';background:#DDE5ED;color:#0C77CF;font-weight:bold;}
        ...
        <div id="page-content" class="homecontainer" style="position:absolute; height:100%; overflow:auto">
            <div id="myCarousel" class="carousel slide">
                ...
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="/Public/Home/images/frame/1.jpg" alt="First slide">
                    </div>
                    <div class="item">
                        <img src="/Public/Home/images/frame/2.jpg" alt="First slide">
                    </div>
                    <div class="item">
                        <img src="/Public/Home/images/frame/3.jpg" alt="First slide">
                    </div>
                    <div class="item">
                        <img src="/Public/Home/images/frame/4.jpg" alt="First slide">
                    </div>
                </div>
                <!-- 轮播（Carousel）导航 -->
                <a class="carousel-control left" href="#myCarousel" data-slide="prev"><img src="/Public/Home/images/frame/arrow1.png" alt="">
                </a>
                <a class="carousel-control right" href="#myCarousel" data-slide="next"><img src="/Public/Home/images/frame/arrow2.png" alt="">
                </a>
            </div>
            <!-- <div class="homerowa">
                    ...
                    <div class="homebox">
                        ...
                        <div class="safebox">
                            ...
                            <div class="safeboxright">
                                ...
                                <p>
                                    上次登录的IP：
                                    <?=preg_replace('/(\d+)\.(\d+)\.(\d+)\.(\d+)/is',"$11.$22.*.*", long2ip($login[0]['loginIP'])); ?>
                                </p>
                                <p>
                                    上次登录地址：隐藏地域
                                </p>
                        ...
                        <div class="hometipsbox">
                            <div class="hometipsbox">
                                <ul>
                                    ...
                                    <li>
                                        <p>
                                            <img alt="" src="/Public/Home/images/main/a<?php echo ($ii); ?>.png"> <?php echo ($var["title"]); ?>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <p class="text-primary text-bold">
                                        您需要使用谷歌动态密码或密保卡密码来进行验证，成功后才能关闭异地登录验证。 如果没有申请，请从【
                                        <font class="text-danger">菜单</font>】-&gt;【
                                        <font class="text-danger">安全中心</font>】-&gt;申请谷歌身份验证或密保卡后再来关闭。
                                    </p>
                                </div>
                                <div class="form-group">
                                    <div class="radio">
