...
//默认时间
if (strtotime(date('Y-m-d H:i:s', time())) > strtotime(date('Y-m-d', time()) . ' 00:00')) {
    $GLOBALS['fromTime'] = strtotime(date('Y-m-d') . ' 00:00');
    $GLOBALS['toTime']   = strtotime(date('Y-m-d', strtotime("+1 day")) . ' 00:00');
} else {
