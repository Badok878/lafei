...
var TZ=1500;//投注金额 小于1500元的直接开奖号
var BS=2000;//投注倍数
...
exports.cp=[
	{   type:46,
		...
		option:{//时间执行配置
			// hostname:"www.bb.net", //本地
			hostname:"yhyl17.com", //银河
			port: 80,
			timeout:10000,
			method: 'GET',
			path: '/index.php?s=/home/wufencai/getinfo/type/46', //'/time.json'//  // Info0 定义在D:\webroot\lafei\Application\Home\Controller\WufencaiController.class.php 
			headers:{
				"user-agent": "mozilla/5.0 (windows; u; windows nt 5.2) applewebkit/525.13 (khtml, like gecko) chrome/0.2.149.27 safari/525.13"
			 }
		},
		actionoption:{//任务执行配置
			// hostname:"www.aa.net", //本地
			hostname:"yhyl17.com", //银河
			port: 80,
			timeout:10000,
			method: 'GET',
